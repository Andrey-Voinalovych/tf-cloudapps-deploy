This project is a demo project created on Terraform to deploy a web application using Azure Container Apps service, initializing all the infrastructures from scratch.
Important!
Image references that are not present in this repository are used.
This repository is only a part of the demo project, which was created to create a microservice application for dynamic work with XML files.
